...
plink --bfile ${dir}/SOW52_PART_sex.update --missing
...
plink --bfile ${dir}/SOW52_PART_sex.update --geno 0.2 --mind 0.2 --make-bed --out ${dir}/SOW52_PART_sex.update.2 -keep-allele-order

#Check missingness again and plot
plink --bfile ${dir}/SOW52_PART_sex.update.2 --missing
Rscript --no-save /sc/arion/projects/tauomics/Shrishtee/1_QC_GWAS/hist_miss.R
...
awk '{ if ($1 >= 1 && $1 <= 22) print $2 }' ${dir}/SOW52_PART_sex.update.2.bim > snp_1_22.txt
plink --bfile ${dir}/SOW52_PART_sex.update.2 --extract snp_1_22.txt --make-bed --out ${dir}/SOW52_PART_sex.update.3

# Generate a plot of the MAF distribution
plink --bfile ${dir}/SOW52_PART_sex.update.3 --freq --out MAF_check
...
plink --bfile ${dir}/SOW52_PART_sex.update.3 --maf 0.01 --make-bed --out ${dir}/SOW52_PART_sex.update.4
...
plink --bfile ${dir}/SOW52_PART_sex.update.4 --hardy

awk '{ if ($9 <0.00001) print $0 }' plink.hwe > plinkzoomhwe.hwe
Rscript --no-save /sc/arion/projects/tauomics/Shrishtee/1_QC_GWAS/hwe.R

plink --bfile ${dir}/SOW52_PART_sex.update.4 --hwe 1e-6 --make-bed --out ${dir}/SOW52_PART_sex.update.5
plink --bfile ${dir}/SOW52_PART_sex.update.5 --hwe 1e-10 --hwe-all --make-bed --out ${dir}/SOW52_PART_sex.update.6
...
plink --bfile ${dir}/SOW52_PART_sex.update.6 --extract ../inversions_grch37.txt --range --indep-pairwise 50 5 0.2 --out indepSNP

plink --bfile SOW52_PART_sex.update.6 --extract indepSNP.prune.in --het --out R_check
...
plink --bfile SOW52_PART_sex.update.6 --remove het_fail_ind.txt --make-bed --out SOW52_PART_sex.update.7
...
plink --bfile SOW52_PART_sex.update.7 --extract indepSNP.prune.in --genome --min 0.2 --out pihat_min0.2
...
plink --bfile SOW52_PART_sex.update.7 --check-sex --allow-no-sex
...
plink --bfile SOW52_PART_sex.update.7 --remove sex_discrepancy.txt --make-bed --out upenn_ucla_mssm.chr$i.6 
